//! # gateway-dash
//!
//! A thin client of the REST API with no capability the API lacks. Compiled into the binary so a single command boots the gateway and opens the dashboard.
//!
...
pub const CRATE: &str = "gateway-dash";
