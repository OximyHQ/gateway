//! # gateway-route
//!
//! Picks deployments per request; fallback only before first token; LLM-aware hedging and mid-stream failover; prompt-cache-affinity sticky routing.
//!
...
pub const CRATE: &str = "gateway-route";
